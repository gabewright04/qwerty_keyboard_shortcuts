        ...
        try:
            ...
            for hotkey in self.hotkeys:
                try:
                    ...
                    combo_str = '+'.join(combo_parts) + '+' + key
...
class ModernHotkeyGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Hotkey Manager Pro")
        # CHANGED: Set default window size to 1227x800
    ...
    def setup_styles(self):
        ...
        # Configure styles - CHANGED: foreground to 'black' for better readability
    ...
    def setup_gui(self):
        ...
        ttk.Label(header_frame, text="🚀 Hotkey Manager Pro", style='Title.TLabel').pack(side=tk.LEFT)
        ...
        ttk.Label(self.status_frame, textvariable=self.status_var, style='Status.TLabel').pack(side=tk.LEFT)
        
        # NEW: Help button in header
        ttk.Button(header_frame, text="❓ HELP", 
                  command=self.show_help, style='Primary.TButton').pack(side=tk.RIGHT, padx=(10, 0))
        ...
        key_combo = ttk.Combobox(key_frame, textvariable=self.key_var, width=8,
